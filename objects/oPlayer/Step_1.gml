...
var _jumpReleased = keyboard_check_released(ord("W")) || keyboard_check_released(vk_space) ||  keyboard_check_released(vk_up) 
  
 
var _keyRight = keyboard_check(ord("D"))|| keyboard_check(vk_right)
var _keyLeft = keyboard_check(ord("A"))|| keyboard_check(vk_left)
...
if(state != STATE.GROUNDED && _jump)
{
	...
	else if(check_collision(1,0) && move)
	{
		_jumpDir = -1
		y_vel = -jumpForce * global.time
		x_vel = _jumpDir * wallJumpSpd * global.time
